...
- Цель работы: Реализовать алгоритм поиска в тексте подстрок, соответствующих заданным регулярным выражениям.
 Задание: Построить РВ, описывающее ОГРН юридического лица.Построить РВ, описывающее биткоин-адрес или MultiSig
 биткоин-адрес. Построить РВ для проверки даты, учитывая високосные годы. Формат даты: DD/MM/YYYY
Пример ввода:
1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa wrongbtc
3J98t1WpEZ73CNmQviecrnyiWrnqRhWNLy 123456789
bc1qw508d6qejxtdg4y5r3zarvary0c5xw7kygt080 7707083893
500100732259 notinn
31/12/2021 29/02/2020 29/02/2019 32/01/2021

### Пример вывода всех задач
![image](https://github.com/user-attachments/assets/6e97b3a6-e628-4d1c-8b2a-9b62876fcc28)
